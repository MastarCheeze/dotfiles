  ...
  init = function()
    ...
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(_, bufnr)
        ...
        map("n", "<leader>df", "<cmd>Telescope diagnostics bufnr=0<cr>", opts("show buffer diagnostics"))
        ...
        map("n", "<leader>k", vim.lsp.buf.hover, opts("show docs for item under cursor"))
      end,
    })
  end,
}
